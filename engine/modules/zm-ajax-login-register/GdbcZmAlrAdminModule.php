...
final class GdbcZmAlrAdminModule extends GdbcBaseAdminModule
{
	...
	CONST ZM_ALR_LOGIN_FORM         = 'IsLoginActivated';
	CONST ZM_ALR_REGISTER_FORM      = 'IsRegisterActivated';

	private $arrDefaultSettingOptions = array(

			self::ZM_ALR_LOGIN_FORM    => array(
				'Id'         => 1,
				'Value'      => NULL,
			...
			self::ZM_ALR_REGISTER_FORM  => array(
				'Id'         => 2,
				'Value'      => NULL,
	...
	{
		return  __('ZM Ajax Login Register', $this->PLUGIN_SLUG);
	}


	protected function getModuleSettingSections()
	{
		$settingSection = new MchWpSettingSection($this->moduleSetting->SettingKey . '-section', "ZM Ajax Login Register");
	...
	{
		echo '<h4 id = "' . $arrSectionInfo['id'] . '">Enable GoodBye Captcha protection for the following forms:</h4>';
	}
